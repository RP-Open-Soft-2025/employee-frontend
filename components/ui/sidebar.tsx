      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex gap-4 h-full w-full has-[[data-variant=inset]]:bg-sidebar',
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'duration-200 absolute top-0 bottom-0 left-0 z-10 hidden h-full w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute top-0 bottom-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex',
